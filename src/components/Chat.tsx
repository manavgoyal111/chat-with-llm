...
export default function ChatPage() {
    ...
    const processVoiceInput = async (audioFile) => {
        try {
            ...
            return response || "Voice message processed";
        } catch (error) {
    ...
    const sendMessage = async (input, inputType) => {
        ...
        try {
            ...
            if (inputType === "text") {
                ...
                textContent = await processVoiceInput(input);
            } else if (inputType === "image") {
                textContent = await processImageInput(input);
            }
